...
const FooterCard = () => {
  ...
  data-slot="button"
  className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive gap-1.5 has-[>svg]:px-2.5 h-9 w-9 rounded-sm border border-white/25 p-0 bg-black text-white hover:bg-neutral-50 hover:text-neutral-700 dark:border-neutral-800 dark:bg-neutral-300 dark:text-neutral-900 dark:hover:bg-neutral-900 dark:hover:text-neutral-300"
>
  <svg
  ...
  >
    ...
    <circle cx="4" cy="4" r="2"></circle>
      ...
      <div className='py-8 px-12 flex text-center text-[#D4D4D4] font-extralight  -mb-5  font-[font2] text-[14px] '>
