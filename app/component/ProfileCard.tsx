...
<div className='h-auto min-h-44 sm:min-h-48 lg:h-64 border-1 border-white/15 w-full rounded-xl'>
            ...
            <div className={`${appName ? 'border-white/25 border bg-white/5 backdrop-blur-sm' : ''} py-1.5 px-2 sm:py-2 sm:px-3 lg:py-2.5 lg:px-4 rounded-lg sm:rounded-xl lg:rounded-2xl flex  sm:gap-2 lg:gap-3 ${appName ? 'justify-between' : 'justify-center'} items-center w-full sm:w-auto`}>
    {appName && (
    ...
    <div className='flex gap-1 sm:gap-1.5 lg:gap-2 items-center'>
        ...
        <span className={`font-medium text-xs sm:text-sm lg:text-base whitespace-nowrap ${appName ? 'text-white truncate max-w-12 sm:max-w-16 lg:max-w-24' : '-mt-14 sm:mt-0 text-gray-400'}`}>
            ...
            <div className='mt-2 sm:mt-3 -mb-3 sm:-mb-5 flex flex-wrap px-2 sm:px-4 lg:px-5 items-start gap-2 sm:gap-3 lg:gap-5 text-xs sm:text-sm font-[font1] pt-2 sm:pt-3 lg:pt-2 pb-3 sm:pb-4'>
