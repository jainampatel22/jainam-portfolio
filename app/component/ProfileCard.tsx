...
const ProfileCard = () => {
    return (
<div className='h-auto min-h-48 lg:h-56 border-1 border-white/15 w-full rounded-xl'>
            ...
            <div className='flex justify-start gap-2 sm:gap-3 items-start px-3 sm:px-4'>
                <div className='bg-[#262626] w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex-shrink-0'>
                    <div className='flex font-bold cursor-pointer justify-center items-center h-full text-base sm:text-lg font-[font1]'>
                        JP
                    </div>
                </div>
                <h1 className='pt-2 sm:pt-3 lg:pt-4 font-[font2] text-2xl sm:text-3xl font-semibold text-white'>Jainam Patel</h1>
            </div>
            <div className='flex flex-wrap gap-2 sm:gap-3 px-3 sm:px-4 lg:px-5 text-xs sm:text-sm font-[font2] text-white/70 pt-2 sm:pt-3'>
                <div>
                    20, he/him
                </div>
