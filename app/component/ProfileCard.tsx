...
<div className='h-auto min-h-44 sm:min-h-48 lg:h-64 border-1 border-white/15 w-full rounded-xl'>
            ...
            <div className={`${appName ? ' flex justify-end items-end gap-3 border-white/25 border bg-white/5 backdrop-blur-sm' : ''} py-1.5  sm:py-2 sm:px-3 lg:py-2.5 lg:px-4 rounded-lg sm:rounded-xl lg:rounded-2xl flex  sm:gap-2 lg:gap-3 ${appName ? 'justify-between' : 'justify-center'} ml-10 px-4 sm:w-auto`}>
    {appName && (
