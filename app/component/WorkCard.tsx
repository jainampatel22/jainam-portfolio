...
const WorkCard = () => {
  return (
    <div id='experience' className='max-h-xl border-1 border-white/15 w-full rounded-xl'>
      <div>
      ...
      <div className='px-3 sm:px-4 -mt-2 pb-4 sm:pb-6'>
        <div className='h-auto min-h-44 lg:h-44 border-1 mt-5 sm:mt-6 lg:mt-7 border-white/15 w-full rounded-xl'>
          ...
          <div className='flex flex-col sm:flex-row gap-2 sm:gap-4 items-start py-3 sm:py-4 px-3 sm:px-4'>
            ...
            <div className='text-xs sm:text-sm -mt-1 sm:mt-0 font-[font2] px-2 sm:px-3 ml-0 sm:ml-14 py-1 bg-[#171717] border border-white/15 rounded-full self-start'>
              March 2025 – May 2025
            </div>
          </div>
          ...
          <div className='px-3 sm:px-6 md:px-12 lg:px-18 -mt-4 sm:-mt-6 pb-3 sm:pb-4'>
            <div className='text-xs sm:text-sm font-[font2] text-[#D4D4D4] pt-1'>Founding Engineer</div>
